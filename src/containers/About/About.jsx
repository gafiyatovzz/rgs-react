...
на ремонт вашего автомобиля"
        ...
        <div className="container">
          ...
          <p className="content_ph">
            Мы предлагаем гарантийные программы на автомобили от 2000 года
            выпуска, с пробегом до 200 000 км. В программе могут учавтсвовать автомобили Российских и Китайских марок от 2010 года и с пробегом до 150 000 км. Наша гарантия покрывает ремонт
            таких агрегатов автомобиля как двигатель, кпп, акпп, вариатор,
            роботизированная кп, редукторы, приводы 4х4 и многие другие узлы.
          </p>
        </div>
      </div>
    </>
