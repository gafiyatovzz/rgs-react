    ...
    <>
      ...
      <div className="container page">
        <Block title="Об услуге от компании РосГарантСервис">
          <p>
            Компания <Name /> представляет уникальную услугу на российском рынке
            - гарантийное обслуживание автомобилей с пробегом. Сегодня мы
            занимаем лидирующее положение в этом стремительно развивающемся
            сегменте автомобильного сервиса.
          </p>
          <p>
          ...
          <p>
            <strong>Мы хотим, чтобы Вы всегда оставались на ходу.</strong>
          </p>
